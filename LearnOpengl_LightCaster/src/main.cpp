...
int main()
{
	...
	Shader objShader("C:/Users/P7XXTM1-G/Desktop/shader/LightCaster/vert.txt", "C:/Users/P7XXTM1-G/Desktop/shader/LightCaster/fragSpotLight.txt");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//给光结构体赋值
		objShader.setVec3("light.ambient", glm::vec3(0.1f));//环境光
		objShader.setVec3("light.diffuse", glm::vec3(0.8f));//漫反射光照
		objShader.setVec3("light.specular", glm::vec3(1.0f));//镜面光

		objShader.setVec3("light.position", myCamera.Position);//聚光灯光源位置
		objShader.setVec3("light.direction", myCamera.Front);//聚光灯方向
		objShader.setFloat("light.cutOff", glm::cos(glm::radians(12.5f)));//聚光灯内圆锥余弦值
		objShader.setFloat("light.outerCutOff", glm::cos(glm::radians(17.5f)));//聚光灯内圆锥余弦值
